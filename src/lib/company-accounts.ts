...
export function toSafeCompanyAccount(
  ...
  return {
    ...
    ownerPhoneNormalized: account.ownerPhoneNormalized,
    ownerPhoneVerificationStatus: account.ownerPhoneVerificationStatus,
    ownerPhoneVerifiedAt: account.ownerPhoneVerifiedAt,
