export const DEFAULT_STUDIO_ENHANCEMENT_PROMPT =
  'Kaynak görseli yalnızca kompozisyon ve mülk referansı olarak kullan; sahneyi Stable Image Ultra ile baştan yeniden oluştur. Görseli profesyonel, tam kare bir kamerayla ve kaliteli bir lensle yeni çekilmiş gibi yüksek ayrıntılı, fotogerçekçi bir emlak ve mimari fotoğraf olarak üret. Mülkün kimliğini, ana mimarisini, oda düzenini, cepheyi, manzarayı ve gerçekçi oranları koru; ancak pikselleri kopyalamak veya yalnızca filtre uygulamak yerine ışığı, malzemeleri, yüzey ayrıntılarını, renkleri, perspektifi ve genel sunumu yeniden üret. Temiz doğal ışık, dengeli beyaz ayarı, güçlü dinamik aralık ve profesyonel netlik kullan. İnsan, yazı, logo, filigran, satış tabelası veya mülkte bulunmayan yanıltıcı mimari unsur ekleme. Sonuç kaynak fotoğraftan açıkça farklı, yeni üretilmiş ve yayın kalitesinde olsun.';
